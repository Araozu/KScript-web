...
import {
    modificadorComilla,
    modificadorParentesisAb,
    modificadorParentesisCer,
    modificadorLlaveAb,
    modificadorLlaveCer,
    modificadorCorcheteAb,
    modificadorCorcheteCer
} from "@/components/Editor/editor-modificadores/Interface";
        ...
        const manejarInput = (ev) => {
            ...
            switch (ev.inputType) {
                case "insertText": {
                    ...
                    const datosModificador = {
                        linea: strAjustado,
                        posicionCursor: elem.selectionEnd - posAbsInicioLinea
                    };

                    switch (caracterIngresado) {
                        case "\"": {
                            strAjustado = modificadorComilla(datosModificador);
                            break;
                        }
                        case "(": {
                            strAjustado = modificadorParentesisAb(datosModificador);
                            break;
                        }
                        case ")": {
                            strAjustado = modificadorParentesisCer(datosModificador);
                            break;
                        }
                        case "{": {
                            strAjustado = modificadorLlaveAb(datosModificador);
                            break;
                        }
                        case "}": {
                            strAjustado = modificadorLlaveCer(datosModificador);
                            break;
                        }
                        case "[": {
                            strAjustado = modificadorCorcheteAb(datosModificador);
                            break;
                        }
                        case "]": {
                            strAjustado = modificadorCorcheteCer(datosModificador);
                            break;
                        }
                    }
